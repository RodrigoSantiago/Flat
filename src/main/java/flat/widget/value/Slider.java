...
public class Slider extends Widget {
    ...
    public void applyAttributes(Controller controller) {
        ...
        setValueRange(attrs.getAttributeNumber("min-value", getMinValue()), attrs.getAttributeNumber("max-value", getMaxValue()));
    ...
    public void onDraw(SmartContext context) {
        ...
        context.setStroker(new BasicStroke(getLineWidth()));
        if (hor) {
